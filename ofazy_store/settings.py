"""
Django settings for ofazy_store project.
...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-fallback-key-for-production-change-this-immediately')

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = os.environ.get('DEBUG', 'False') == 'True'

ALLOWED_HOSTS = ['*']
# In production, you should list your specific domains:
...
WSGI_APPLICATION = 'ofazy_store.wsgi.application'
